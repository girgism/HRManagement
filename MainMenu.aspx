<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MainMenu.aspx.cs" Inherits="Raya_T.MainMenu" %>
...
&nbsp;&nbsp;
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        <asp:View ID="View1" runat="server">
            <br />
                <br />
            <asp:GridView class="table table-striped table-hover" ID="grdEmp" runat="server" OnRowDataBound="grdEmp_RowDataBound" OnRowDeleting="grdEmp_RowDeleting" >
