<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditEmp.aspx.cs" Inherits="Raya_T.EditEmp" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

     <div class="container R-form">
         <h2 class="text-center text-light"> Editing Employee Data </h2>
         <br />
         ...
         <div class="form-group row">
          ...
          <div class="form-group row">
            <div class="col-sm-10 ">
                <asp:Button ID="btnSave" runat="server" Text="Save" class="btn btn-success" ValidationGroup="OK" OnClick="btnSave_Click" />
